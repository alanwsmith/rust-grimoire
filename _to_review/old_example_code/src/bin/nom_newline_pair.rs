// This is an abandoned first attempt. Look
// for the working code in the file:
//
// nom_get_lines_after_a_tag.rs
//
// Leaving this here for now to pull the
// tests into the other file
